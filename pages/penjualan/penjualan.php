                  ...
                  <div class="table-container">
                    ...
                    <table class="table">
                      ...
                      <tbody class="table__tbody">
                        <?php 
                          $query = mysqli_query($cons, "SELECT * FROM tbl_transaksi INNER JOIN tbl_barang ON tbl_barang.id_barang=tbl_transaksi.id_barang GROUP BY tbl_transaksi.id_barang, tbl_barang.id_barang");
